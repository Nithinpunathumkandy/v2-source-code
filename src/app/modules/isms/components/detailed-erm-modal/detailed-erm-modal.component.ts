...
import { ErmDetailsReportService } from "src/app/core/services/isms/report/erm-detail-report/erm-details-report.service";
import { HttpErrorResponse } from "@angular/common/http";
import { ErmDetailsStore } from "src/app/stores/isms/report/erm-details/erm-details-store";
...
export class DetailedErmModalComponent implements OnInit {
	...
	constructor(
		...
		private _ermDetailReportServuce: ErmDetailsReportService,
		...
		save.subscribe(
		  (res: any) => {
			...
			this._router.navigateByUrl(
			  "/isms/reports/isms-pdf-report/isms-detailed-erm-report/" + ErmDetailsStore.id
			);
			this.closeFormModal()
