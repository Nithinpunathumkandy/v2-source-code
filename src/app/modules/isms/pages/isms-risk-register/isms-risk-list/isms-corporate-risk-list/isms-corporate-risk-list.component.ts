...
@Component({
  selector: 'app-isms-corporate-risk-list',
  templateUrl: './isms-corporate-risk-list.component.html',
  styleUrls: ['./isms-corporate-risk-list.component.scss']
})
export class IsmsCorporateRiskListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reactionDisposer = autorun(() => {
      ...
      if(IsmsRisksStore.is_registered)
 ...
 */
  ...
  openFormModal() {
    // if(IsmsRisksStore.corporate == true){
    IsmsRisksStore.addCorporate = true;
    // }
    this._router.navigateByUrl('isms/corporate-isms-risks/add-isms-risk');
  ...
  getDetails(id) {
    ...
    this._router.navigateByUrl('isms/corporate-isms-risks/' + id);
