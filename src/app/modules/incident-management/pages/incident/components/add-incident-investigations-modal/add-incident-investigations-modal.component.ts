...
@Component({
  selector: 'app-add-incident-investigations-modal',
  templateUrl: './add-incident-investigations-modal.component.html',
  styleUrls: ['./add-incident-investigations-modal.component.scss']
})
export class AddIncidentInvestigationsModalComponent implements OnInit {
  form: FormGroup;
  formErrors: any;
  ...
  cancel() {
    this._eventEmitterService.dismissInvestigationModalControl();
