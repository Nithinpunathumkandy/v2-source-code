...
@Component({
  selector: 'app-incident-workflow-team-add',
  templateUrl: './incident-workflow-team-add.component.html',
  styleUrls: ['./incident-workflow-team-add.component.scss']
})
export class IncidentWorkflowTeamAddComponent implements OnInit {
  ...
  save(close: boolean = false){
    ...
    if(this.commonForm.value){
      ...
      save = this._incidentWorkflowService.saveUserTeamAdd(saveData,this.WorkFlowSource.values?this.WorkFlowSource.values.workflowId:'');
    }
  ...
  close() {
    this.resetForm();
    this._eventEmitterService.dismissIncidentWorkflowTeamAddModal()
  }
