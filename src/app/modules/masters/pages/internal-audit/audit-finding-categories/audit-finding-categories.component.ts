...
@Component({
  ...
  selector: 'app-audit-finding-categories',
  templateUrl: './audit-finding-categories.component.html',
  styleUrls: ['./audit-finding-categories.component.scss']
})
export class AuditFindingCategoriesComponent implements OnInit , OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.reactionDisposer = autorun(() => {
      ...
      var subMenuItems = [
        {activityName: 'FINDING_CATEGORY_LIST', submenuItem: { type: 'search' }},
        {activityName: 'CREATE_FINDING_CATEGORY', submenuItem: {type: 'new_modal'}},
        {activityName: 'GENERATE_FINDING_CATEGORY_TEMPLATE', submenuItem: {type: 'template'}},
        {activityName: 'EXPORT_FINDING_CATEGORY', submenuItem: {type: 'export_to_excel'}},
        // {activityName: 'SHARE_FINDING_CATEGORY', submenuItem: {type: 'share'}},
        {activityName: 'IMPORT_AUDIT_OBJECTIVE', submenuItem: {type: 'import'}},
        {activityName: null, submenuItem: {type: 'close', path:'internal-audit'}},
      ]
      if(!AuthStore.getActivityPermission(1100,'CREATE_FINDING_CATEGORY')){
  ...
  sortTitle(type: string) {
    // AuditFindingCategoryMasterStore.setCurrentPage(1);
