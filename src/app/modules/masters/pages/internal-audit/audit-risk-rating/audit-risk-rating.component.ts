...
import { RiskRatingService } from 'src/app/core/services/masters/internal-audit/risk-rating/risk-rating.service';
...
@Component({
  ...
  selector: 'app-audit-risk-rating',
  templateUrl: './audit-risk-rating.component.html',
  styleUrls: ['./audit-risk-rating.component.scss']
})
export class AuditRiskRatingComponentRiskmanagement implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.reactionDisposer = autorun(() => {
      ...
      var subMenuItems = [
        {activityName: 'INTERNAL_RISK_RATING_LIST', submenuItem: { type: 'search' }},
        {activityName: 'INTERNAL_RISK_RATING_LIST', submenuItem: {type: 'export_to_excel'}},
        // {activityName: 'SHARE_INTERNAL_RISK_RATING', submenuItem: {type: 'share'}},
