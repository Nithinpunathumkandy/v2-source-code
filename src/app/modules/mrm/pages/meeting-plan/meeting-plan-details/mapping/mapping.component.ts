...
export class MappingComponent implements OnInit {
  ...
  deleteIssueMapping(id){//delete
    ...
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_issue_from_meeting_plan';
  ...
  deleteProcessMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_process_from_meeting_plan';
  ...
  deleteRiskMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_risk_from_meeting_plan';
  ...
  deleteControlMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_control_from_meeting_plan';
  ...
  deleteProjectMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_project_from_meeting_plan';
  ...
  deleteProductMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_product_from_meeting_plan';
  ...
  deleteCustomertMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_customer_from_meeting_plan';
  ...
  deleteObjectivetMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_objective_from_meeting_plan';
  ...
  deleteFindingsMapping(id){//delete
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_audit_finding_from_meeting_plan';
  ...
  deleteNonConformityMapping(id){
    ...
    this.deleteObject.type = '';
    this.deleteObject.subtitle = 'are_you_sure_you_want_to_detach_this_non_conformity_finding_from_meeting_plan';
