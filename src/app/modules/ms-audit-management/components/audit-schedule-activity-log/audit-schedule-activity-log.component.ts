...
@Component({
  selector: 'app-audit-schedule-activity-log',
  templateUrl: './audit-schedule-activity-log.component.html',
  styleUrls: ['./audit-schedule-activity-log.component.scss']
})
export class AuditScheduleActivityLogComponent implements OnInit,OnDestroy {

  AppStore= AppStore;
  AuditPlanActivityLogsStore = AuditPlanActivityLogsStore;
  OrganizationGeneralSettingsStore= OrganizationGeneralSettingsStore;

  emptyActivityLog = "audit_schedule_activity_logs_empty";
  ...
  pageChange(newPage: number = null) {
    ...
    this._activityLogsService.getItemsScheduleActivityLog(false,null).subscribe(() => setTimeout(() => this._utilityService.detectChanges(this._cdr), 100));
  }
  ...
  cancel() {
    this._eventEmitterService.dismissAuditScheduleActivityLogsModal();
  }
