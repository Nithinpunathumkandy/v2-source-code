...
@Component({
  selector: 'app-audit-report-update-modal',
  templateUrl: './audit-report-update-modal.component.html',
  styleUrls: ['./audit-report-update-modal.component.scss']
})
export class AuditReportUpdateModalComponent implements OnInit {
  ...
  closeAuditReport(){
    this._eventEmitterService.dismissAuditReportModal()
  }
