...
declare var $: any;
@Component({
  selector: 'app-findings-rca',
  templateUrl: './findings-rca.component.html',
  styleUrls: ['./findings-rca.component.scss']
})
export class FindingsRcaComponent implements OnInit,OnDestroy {
      ...
      if (SubMenuItemStore.clikedSubMenuItem) {
        switch (SubMenuItemStore.clikedSubMenuItem.type) {
          ...
          case "export_to_excel":
            this._msauditFindingsRcaService.exportToExcel(AuditNonConfirmityStore.msAuditNonConfirmityId);
            break;
  ...
  pageChange(newPage: number = null) {
    ...
    this._msauditFindingsRcaService.getItems(AuditNonConfirmityStore.msAuditNonConfirmityId).subscribe(res=>{
  ...
  openFormModal() {
    ...
    AuditNonConfirmityStore.rcaDataLength = FindingRCAStore.allItems.length;
    setTimeout(() => {
  ...
  addRCA() {
    ...
    {
      this._utilityService.showWarningMessage('warning','auditee_only add_rca')
    }
  ...
  editRCA(id:number){
    const rca: RootCauseAnalysis = FindingRCAStore.getRCAById(id);
    //set form value
  ...
  modalControl(status: boolean) {
    ...
    if (status && this.popupObject.id) {
      this._msauditFindingsRcaService.delete(AuditNonConfirmityStore.msAuditNonConfirmityId, this.popupObject.id).subscribe(res=>{
        this.pageChange();
        this._utilityService.detectChanges(this._cdr);
      });
