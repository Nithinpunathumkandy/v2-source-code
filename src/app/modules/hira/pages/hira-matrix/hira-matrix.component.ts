...
@Component({
  selector: 'app-hira-matrix',
  templateUrl: './hira-matrix.component.html',
  styleUrls: ['./hira-matrix.component.scss']
})
export class HiraMatrixComponent implements OnInit {
  ...
  constructor(private _router: Router,
		private _riskScoreService: HiraScoreService,
