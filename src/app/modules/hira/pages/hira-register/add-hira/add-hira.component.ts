...
export class AddHiraComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder,
	...
	submitForm() {
		...
		if (RisksStore.riskId) {
			save = this._hiraService.updateItem(RisksStore.riskId, this.saveData);
		}
		else {
			// console.log(this.saveData);

			save = this._hiraService.saveItem(this.saveData);
		}
