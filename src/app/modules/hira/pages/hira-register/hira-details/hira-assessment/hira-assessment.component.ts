...
@Component({
  selector: 'app-hira-assessment',
  templateUrl: './hira-assessment.component.html',
  styleUrls: ['./hira-assessment.component.scss']
})
export class HiraAssessmentComponent implements OnInit {
  ...
  constructor(private _helperService: HelperServiceService,
    ...
    getRiskDetails(id) {
      this._hiraService.getItem(id).subscribe(res=>{
  ...
  downloadPdf(file){
    ...
    openProcess(id) {
      ...
      this._hiraAssessmentService.getItemByProcess(id).subscribe(res => {
    ...
    submitAssessment() {
      ...
      this._hiraAssessmentService.updateItem(saveData).subscribe(res => {
