...
@Component({
  selector: 'app-hira-context',
  templateUrl: './hira-context.component.html',
  styleUrls: ['./hira-context.component.scss']
})
export class HiraContextComponent implements OnInit {
  ...
  constructor(private _utilityService: UtilityService,
    ...
    private _hiraJourneyService: HiraJourneyService) { }
    ...
    ngOnInit(): void {
      ...
      this._hiraService.getItem(RisksStore.riskId).subscribe(resp => {
        this._utilityService.detectChanges(this._cdr);
        setTimeout(() => {
          if (resp['is_analysis_performed'] == 1) {
            this._hiraService.getContextChart(RisksStore.riskId).subscribe(res => {            
