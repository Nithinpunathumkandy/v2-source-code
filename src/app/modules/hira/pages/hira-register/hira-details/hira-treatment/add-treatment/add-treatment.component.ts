...
export class AddTreatmentComponent implements OnInit {
  ...
  constructor(private _eventEmitterService: EventEmitterService,
    ...
    private _hiraTreatmentService: HiraTreatmentService,
 ...
 */
  ...
  submitForm() {
    ...
    if (this.regForm.value.id) {
      save = this._hiraTreatmentService.updateItem(this.regForm.value.id, this.processFormValues('update'));
    } else {
      this.regForm.removeControl('id');
      save = this._hiraTreatmentService.saveItem(this.processFormValues('update'));
    }
