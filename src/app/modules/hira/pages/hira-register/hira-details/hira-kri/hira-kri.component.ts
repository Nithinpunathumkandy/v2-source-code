...
import { KRI } from 'src/app/core/models/hira/hira-register/hira-kri';
import { KRIStore } from 'src/app/stores/hira/hira/kri.store';
import { BreadCrumbMenuItemStore } from 'src/app/stores/general/breadcrumb-menu.store';
import { KriService } from 'src/app/core/services/hira/hira/kri/kri.service';

declare var $: any;

@Component({
  selector: 'app-hira-kri',
  templateUrl: './hira-kri.component.html',
  styleUrls: ['./hira-kri.component.scss']
})
export class HiraKriComponent implements OnInit {
