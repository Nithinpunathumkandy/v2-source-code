...
import { RCAStore } from 'src/app/stores/hira/hira/rca-risk.store';
import { RisksStore } from 'src/app/stores/hira/hira/hira.store';
import { RootCauseAnalysis } from 'src/app/core/models/hira/hira-register/root-cause-analyses';
import { HiraRcaService } from 'src/app/core/services/hira/hira/hira-rca/hira-rca.service';
...
@Component({
  selector: 'app-hira-rca',
  templateUrl: './hira-rca.component.html',
  styleUrls: ['./hira-rca.component.scss']
})
export class HiraRcaComponent implements OnInit {
  ...
  constructor(private _rootCauseAnalysesService:HiraRcaService,
