...
@Component({
  selector: 'app-assessment-action-plan-details',
  templateUrl: './assessment-action-plan-details.component.html',
  styleUrls: ['./assessment-action-plan-details.component.scss']
})
export class AssessmentActionPlanDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(params => {
      ...
      let id = +params['id'];
      BAActionPlanStore.actionPlanId=id
  ...
  getActionPlanDetails(actionPlanId){
    ...
    this._BAactionPlanService.getItem(actionPlanId).subscribe(res=>{
      this._utilityService.detectChanges(this._cdr)
    })
  ...
  getremainingDateChartAttendance() {
    ...
    const startDate: any = new Date(BAActionPlanStore.BAActionPlanDetails?.start_date);
    const targetDate: any = new Date(BAActionPlanStore.BAActionPlanDetails?.target_date);
  ...
  getColorKey() {
    var label_color = BAActionPlanStore.BAActionPlanDetails?.business_assessment_action_plan_status?.label.split('-');
  ...
  getPopupDetails(user,is_created_by:boolean = false){
    ...
    if(user){
      ...
      if(is_created_by) userDetailObject['created_at'] = BAActionPlanStore.BAActionPlanDetails.created_at;
