...
@Component({
  selector: 'app-action-plan-status-update-modal',
  templateUrl: './action-plan-status-update-modal.component.html',
  styleUrls: ['./action-plan-status-update-modal.component.scss']
})
export class ActionPlanStatusUpdateModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form = this._formBuilder.group({
      ...
      business_assessment_action_plan_status_id: [null, Validators.required],
      comment: [''],
      documents: [[], '']
    });
  ...
  setPercentage(percentage) {
    if (percentage == '100%')
      this.form.controls['business_assessment_action_plan_status_id'].setValue(3);
    else if (percentage == '0%')
      this.form.controls['business_assessment_action_plan_status_id'].setValue(1);
    else
      this.form.controls['business_assessment_action_plan_status_id'].setValue(2);
  }
  ...
  setFormData(data) {
    ...
    this.form.patchValue({
      ...
      business_assessment_action_plan_status_id: data?.meeting_action_plan_status ? data.meeting_action_plan_status.id : 1,
    })
  }
  ...
  closeFormModal(close?) {
    this._eventEmitterService.dismissBAActionPlanStatusModal(close);
  }
  ...
  getSaveData() {
    ...
    this.saveData = {
      ...
      business_assessment_action_plan_status_id: this.form.value.business_assessment_action_plan_status_id ? this.form.value.business_assessment_action_plan_status_id : null,
  ...
  save(close: boolean = false) {
    if (this.form.value) {
      ...
      if (this.form.value) {
        save = this._baActionPlanService.updateActionPlanStatus(this.source.id, this.saveData);
      }
      save.subscribe(
        (res: any) => {
          this.resetForm();
