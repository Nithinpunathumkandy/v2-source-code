...
@Component({
  selector: 'app-plan-measure-history',
  templateUrl: './plan-measure-history.component.html',
  styleUrls: ['./plan-measure-history.component.scss']
})
export class PlanMeasureHistoryComponent implements OnInit {
  @Input('source') planMeasureHistorySource: any;
  ...
  cancel(){
    this._eventEmitterService.dismissKpiPlanMeasureModal()
  }
