...
@Component({
  selector: 'app-action-plan-workflow-history',
  templateUrl: './action-plan-workflow-history.component.html',
  styleUrls: ['./action-plan-workflow-history.component.scss']
})
export class ActionPlanWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) ActionPlanWorkflowStore.setCurrentPage(newPage);
