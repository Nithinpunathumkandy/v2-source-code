...
@Component({
  selector: 'app-objective-workflow-history',
  templateUrl: './objective-workflow-history.component.html',
  styleUrls: ['./objective-workflow-history.component.scss']
})
export class ObjectiveWorkflowHistoryComponent implements OnInit {
  ProjectClosureStore = ProjectClosureStore;
  ObjectiveWorkflowStore = ObjectiveWorkflowStore
  ...
  pageChange(newPage: number = null) {
    if (newPage) ObjectiveWorkflowStore.setCurrentPage(newPage);
