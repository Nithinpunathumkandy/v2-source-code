...
@Component({
  selector: 'app-strategy-department-details',
  templateUrl: './strategy-department-details.component.html',
  styleUrls: ['./strategy-department-details.component.scss']
})
export class StrategyDepartmentDetailsComponent implements OnInit {
