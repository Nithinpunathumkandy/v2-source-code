...
@Component({
  selector: 'app-external-users-modal',
  templateUrl: './external-users-modal.component.html',
  styleUrls: ['./external-users-modal.component.scss']
})
export class ExternalUsersModalComponent implements OnInit {
...
processDataForSave() {
  ...
  save(close: boolean = false) {
    ...
    if (this.form.valid) {
      ...
      AppStore.enableLoading();
       ProjectChangeRequestStore.setExternalUsers(this.processDataForSave)
  ...
  cancel(){
    this._eventEmitterService.dismissExternalUserChangeReq();
   }
