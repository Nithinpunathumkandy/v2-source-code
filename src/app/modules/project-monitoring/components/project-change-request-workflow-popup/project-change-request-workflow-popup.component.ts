...
@Component({
  selector: 'app-project-change-request-workflow-popup',
  templateUrl: './project-change-request-workflow-popup.component.html',
  styleUrls: ['./project-change-request-workflow-popup.component.scss']
})
export class ProjectChangeRequestWorkflowPopupComponent implements OnInit {
  ...
  closeWorkflowModal(){
    this._eventEmitterService.dismissProjectChangeRequestWorkflowModal();
  }
