...
@Component({
  selector: 'app-project-closure-workflow-history',
  templateUrl: './project-closure-workflow-history.component.html'
})
export class ProjectClosureWorkflowHistoryComponent implements OnInit {
  ...
  closeWorkflowHistory(){
    this._eventEmitterService.dismissProjectClosureHistoryModal();
  }
