...
@Component({
  selector: 'app-project-assumptions',
  templateUrl: './project-assumptions.component.html',
  styleUrls: ['./project-assumptions.component.scss']
})
export class ProjectAssumptionsComponent implements OnInit, OnDestroy {
  ...
  editScope(type,scope){
    ...
    this.openNewScope()
     ...
     delete(id: number) {
      ...
      this.popupObject.title = 'assumption?';
