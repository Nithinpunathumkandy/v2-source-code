...
@Component({
  selector: 'app-bc-strategy-workflow-history',
  templateUrl: './bc-strategy-workflow-history.component.html',
  styleUrls: ['./bc-strategy-workflow-history.component.scss']
})
export class BcStrategyWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) BcmStrategyStore.historyPage = newPage;
    this._bcmStrategiesService.strategyWorkFlowHistory(false,null,BcmStrategyStore.new_strategy_id).subscribe(res=>{
  ...
  closeWorkflowHistory(){
    this._eventEmitterService.dismissStrategyWorkFlowHistoryModal();
  }
