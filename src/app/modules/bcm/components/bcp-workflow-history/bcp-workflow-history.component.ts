...
@Component({
  selector: 'app-bcp-workflow-history',
  templateUrl: './bcp-workflow-history.component.html',
  styleUrls: ['./bcp-workflow-history.component.scss']
})
export class BcpWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) BcpStore.workflowHistoryPage = newPage;
    this._bcpService.getWorkflowHistory(BcpStore.bcpDetails.id).subscribe(res=>{
