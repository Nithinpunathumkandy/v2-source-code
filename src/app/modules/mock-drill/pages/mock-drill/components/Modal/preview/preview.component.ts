...
export class PreviewComponent implements OnInit {
  ...
  constructor(
    ...
    private _actionPlanService: MockDrillActionPlanService
  ) { }
  ...
  downloadFile() {
    ...
    if (this.iFrameSource.component == 'document-version') {
      ...
      this._actionPlanService.downloadFile(this.iFrameSource.component, this.iFrameSource.componentId, this.iFrameSource.file_details.id, this.iFrameSource.updateId, this.iFrameSource.file_details.title, this.iFrameSource.file_details);
    }
  }
}
