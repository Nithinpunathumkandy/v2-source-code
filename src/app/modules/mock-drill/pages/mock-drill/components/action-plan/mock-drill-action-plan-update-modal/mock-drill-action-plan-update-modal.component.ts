...
import { MockDrillActionPlanStatusService } from 'src/app/core/services/mock-drill/mock-drill-action-plan-status/mock-drill-action-plan-status.service';
...
declare var $: any;
@Component({
  selector: 'app-mock-drill-action-plan-update-modal',
  templateUrl: './mock-drill-action-plan-update-modal.component.html',
  styleUrls: ['./mock-drill-action-plan-update-modal.component.scss']
})
export class MockDrillActionPlanUpdateModalComponent implements OnInit {
  ...
  constructor(
    ...
    private _actionPlanStatusService: MockDrillActionPlanStatusService,
  ) { }
  ...
  ngOnInit(): void {
    ...
    this.form = this._formBuilder.group({
      ...
      mock_drill_action_plan_status_id: [null, Validators.required],
      comment: [''],
      documents: [[], '']
    });
  ...
  setPercentage(percentage) {
    if (percentage == '100%')
      this.form.controls['mock_drill_action_plan_status_id'].setValue(3);
    else if (percentage == '0%')
      this.form.controls['mock_drill_action_plan_status_id'].setValue(1);
    else
      this.form.controls['mock_drill_action_plan_status_id'].setValue(2);
  }
  ...
  setFormData(data) {
    ...
    this.form.patchValue({
      ...
      mock_drill_action_plan_status_id: data?.mock_drill_action_plan_status ? data.mock_drill_action_plan_status.id : 1,
    })
  }
  ...
  checkForFileUploadsScrollbar() {//doc-add scrollbar function
    if (MockDrillActionPlanStore.docDetails.length >= 7 || this.fileUploadsArray.length > 7) {
  ...
  getSaveData() {
    this.saveData = {
      ...
      mock_drill_action_plan_status_id: this.form.value.mock_drill_action_plan_status_id ? this.form.value.mock_drill_action_plan_status_id : null,
