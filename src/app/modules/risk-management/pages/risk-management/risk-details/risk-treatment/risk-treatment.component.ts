...
export class RiskTreatmentComponent implements OnInit {
  ...
  viewDocument(document, history_id) {
    this._riskManagementService.getFilePreview('risk-treatment', RiskTreatmentStore.riskTreatmentDetails.id, history_id, document.id).subscribe(res => {
  ...
  openUpdateModal() {
    ...
    //         let docurl = this._riskManagementService.getThumbnailPreview('risk-treatment', i.token);
    //         let docDetails = {
    //           name: i.title,
    //           ext: i.ext,
    //           size: i.size,
 ...
 */
  ...
  downloadDocument(id, filename, file_id?, doc?) {
    ...
    if (file_id) {
      this._riskManagementService.downloadFile('risk-treatment-documents', RiskTreatmentStore.riskTreatmentDetails.id, id, filename, file_id, doc);
    }
