...
import { RiskMappingService } from 'src/app/core/services/risk-management/risks/risk-mapping/risk-mapping.service';
...
export class RiskMappingComponent implements OnInit {
  ...
  constructor(private _riskMappingService: RiskMappingService,
  ...
  closeIncident() {
    if (IncidentStore?.saveSelected) {
      ...
      IncidentStore.saveSelected = false;
      this._riskMappingService.saveIncidentForMapping(saveData).subscribe(res => {
    ...
    if (status && this.deleteObject.id) {
      ...
      switch (this.deleteObject.title) {
        ...
        case 'control':
          ...
          deleteData = this._riskMappingService.deleteIncidentMapping(data) 
          break;
      }
