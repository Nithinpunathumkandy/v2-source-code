...
@Component({
  selector: 'app-corporate-shared-service-divsion',
  templateUrl: './corporate-shared-service-divsion.component.html',
  styleUrls: ['./corporate-shared-service-divsion.component.scss']
})
export class CorporateAndSharedServiceDivisionComponent implements OnInit, OnDestroy {
  ...
  createPieChartForRisk() {
    ...
    let chart = am4core.create("corpChartdiv", am4charts.PieChart);
    ...
    chart.legend.itemContainers.template.tooltipText = '{department}'
