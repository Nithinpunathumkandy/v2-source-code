...
@Component({
  selector: 'app-risk-workflow-add-modal',
  templateUrl: './risk-workflow-add-modal.component.html',
  styleUrls: ['./risk-workflow-add-modal.component.scss']
})
export class RiskWorkflowAddModalComponent implements OnInit {
