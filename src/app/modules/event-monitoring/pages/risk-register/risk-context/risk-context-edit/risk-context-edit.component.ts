...
declare var $: any;
@Component({
  selector: 'app-risk-context-edit',
  templateUrl: './risk-context-edit.component.html',
  styleUrls: ['./risk-context-edit.component.scss']
})
export class RiskContextEditComponent implements OnInit {
  ...
  getSaveData() {
	...
	let saveData = {
		event_id:this.form.value?.event_id ? this.form.value?.event_id : null,
		...
		description: this.form.value?.risk_description ? this.form.value.risk_description : null,
