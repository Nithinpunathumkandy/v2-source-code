...
declare var $: any;
@Component({
  selector: 'app-risk-register-add',
  templateUrl: './risk-register-add.component.html',
  styleUrls: ['./risk-register-add.component.scss']
})
export class RiskRegisterAddComponent implements OnInit {
  ...
  setFormValues() {
	if (this.riskRegisterObject.values) {
		...
		this.form.patchValue({
			...
			event_id: this.riskRegisterObject.values.event_id,
