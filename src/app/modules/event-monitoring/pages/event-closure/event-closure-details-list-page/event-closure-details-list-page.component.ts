...
declare var $: any;
@Component({
  selector: 'app-event-closure-details-list-page',
  templateUrl: './event-closure-details-list-page.component.html',
  styleUrls: ['./event-closure-details-list-page.component.scss']
})
export class EventClosureDetailsListPageComponent implements OnInit,OnDestroy {
