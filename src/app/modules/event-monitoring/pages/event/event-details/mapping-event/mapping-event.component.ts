...
@Component({
  selector: 'app-mapping-event',
  templateUrl: './mapping-event.component.html',
  styleUrls: ['./mapping-event.component.scss']
})
export class MappingEventComponent implements OnInit, OnDestroy {
  ...
  pageChange(newPage: number = null) {
    ...
    this._riskRegisterService.getItems(false,`&event_ids=${EventsStore.selectedEventId}`).subscribe(() => setTimeout(() => this._utilityService.detectChanges(this._cdr), 100));
  }
