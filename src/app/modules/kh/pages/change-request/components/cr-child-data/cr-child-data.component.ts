...
@Component({
  selector: 'app-cr-child-data',
  templateUrl: './cr-child-data.component.html',
  styleUrls: ['./cr-child-data.component.scss']
})
export class CrChildDataComponent implements OnInit {
