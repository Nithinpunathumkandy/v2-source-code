...
@Component({
  selector: 'app-add-risk-mapping-kh',
  templateUrl: './add-risk-mapping-kh.component.html',
  styleUrls: ['./add-risk-mapping-kh.component.scss']
})
export class AddRiskMappingKhComponent implements OnInit {
