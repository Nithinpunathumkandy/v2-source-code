...
@Component({
  selector: 'app-add-audit-finding-modal-kh',
  templateUrl: './add-audit-finding-modal-kh.component.html',
  styleUrls: ['./add-audit-finding-modal-kh.component.scss']
})
export class AddAuditFindingModalKhComponent implements OnInit {
