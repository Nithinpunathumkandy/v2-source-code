...
@Component({
  selector: 'app-share-document-model',
  templateUrl: './share-document-model.component.html',
  styleUrls: ['./share-document-model.component.scss']
})
export class ShareDocumentModelComponent implements OnInit {
  ...
  closeModel(){
    setTimeout(() => {
      this._eventEmitterService.dismissShareDataPopup()
    }, 250);
  }
  ngOnDestroy(){
    this._eventEmitterService.dismissShareDataPopup();
