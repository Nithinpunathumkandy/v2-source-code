...
@Component({
  selector: 'app-am-audit-universe-process-list',
  templateUrl: './am-audit-universe-process-list.component.html',
  styleUrls: ['./am-audit-universe-process-list.component.scss']
})
export class AmAuditUniverseProcessListComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      if (SubMenuItemStore.clikedSubMenuItem) {
        switch (SubMenuItemStore.clikedSubMenuItem.type) {
          ...
          case "export_to_excel":
            this._auditUniverseService.processExportToExcel();
            break;

          case "search":
            AmAuditUniverseStore.searchText = SubMenuItemStore.searchText;
    ...
    RightSidebarLayoutStore.filterPageTag = 'am_audit_universe_process';
  ...
  getProcesses(newPage: number = null) {
    AmAuditUniverseStore.process_loaded = false;
    if (newPage) AmAuditUniverseStore.setProcessCurrentPage(newPage);
    this._auditUniverseService.getProcesses().subscribe(res => {
      this._utilityService.detectChanges(this._cdr);
    })
  }
   ...
   sortTitle(type: string) {
    ...
    this._auditUniverseService.sortProcessList(type, null);
    this.getProcesses();
  }
