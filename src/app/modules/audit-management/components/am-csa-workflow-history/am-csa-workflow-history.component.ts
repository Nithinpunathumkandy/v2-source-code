...
@Component({
  selector: 'app-am-csa-workflow-history',
  templateUrl: './am-csa-workflow-history.component.html',
  styleUrls: ['./am-csa-workflow-history.component.scss']
})
export class AmCsaWorkflowHistoryComponent implements OnInit {
  ...
  closeWorkflowHistory() {
    this._eventEmitterService.dismissCSAHistoryModal();
  }
