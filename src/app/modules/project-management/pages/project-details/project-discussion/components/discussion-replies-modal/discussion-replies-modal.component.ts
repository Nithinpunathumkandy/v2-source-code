...
@Component({
  selector: 'app-discussion-replies-modal',
  templateUrl: './discussion-replies-modal.component.html',
  styleUrls: ['./discussion-replies-modal.component.scss']
})
export class DiscussionRepliesModalComponent implements OnInit {
  ...
  Save(close: boolean = false) {
    ...
    if (this.form.value) {
      ...
      this.form.patchValue({
        project_discussion_id:this.commentId
      })
      ...
      if (this.form.value.id) {
        ...
        save = this._discusiionService.saveReplies(this.form.value, this.commentId);
      }
