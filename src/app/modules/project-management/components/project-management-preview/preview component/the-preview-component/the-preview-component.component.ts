...
@Component({
  selector: 'app-the-preview-component',
  templateUrl: './the-preview-component.component.html',
  styleUrls: ['./the-preview-component.component.scss']
})
export class ThePreviewComponentComponent implements OnInit {
  ...
  downloadFile(){
    ...
    else if (this.iFrameSource.component=='project-documents')
