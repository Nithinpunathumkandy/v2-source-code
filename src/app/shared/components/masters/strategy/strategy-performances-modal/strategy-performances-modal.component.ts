...
@Component({
  selector: 'app-strategy-performances-modal',
  templateUrl: './strategy-performances-modal.component.html',
  styleUrls: ['./strategy-performances-modal.component.scss']
})
export class StrategyPerformancesModalComponent implements OnInit {
  ...
  closeFormModal() {
    this.resetForm();
    this._eventEmitterService.dismissStrategyPerformancesModal();
  }
  ...
  save(close: boolean = false) {
    ...
    if (this.form.value) {
      ...
      if (this.form.value.id) {
        save = this._performancesService.updateItem(this.form.value.id, this.form.value);
      } else {
        delete this.form.value.id
        save = this._performancesService.saveItem(this.form.value);
      }
