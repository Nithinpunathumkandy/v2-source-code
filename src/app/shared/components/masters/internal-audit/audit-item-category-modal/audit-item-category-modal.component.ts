...
declare var $: any;
@Component({
  selector: 'app-audit-item-category-modal',
  templateUrl: './audit-item-category-modal.component.html',
  styleUrls: ['./audit-item-category-modal.component.scss']
})

export class AuditItemCategoryModalComponent implements OnInit {
  ...
  closeFormModal() {
    this.resetForm();
    this._eventEmitterService.dismissAuditItemControlModal();
  }
