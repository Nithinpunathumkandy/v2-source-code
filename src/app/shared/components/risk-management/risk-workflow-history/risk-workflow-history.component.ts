...
@Component({
  selector: 'app-risk-workflow-history',
  templateUrl: './risk-workflow-history.component.html',
  styleUrls: ['./risk-workflow-history.component.scss']
})
export class RiskWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) RiskInfoWorkflowStore.setCurrentPage(newPage);
