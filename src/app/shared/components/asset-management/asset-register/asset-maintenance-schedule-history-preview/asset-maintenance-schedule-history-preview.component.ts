...
@Component({
  selector: 'app-asset-maintenance-schedule-history-preview',
  templateUrl: './asset-maintenance-schedule-history-preview.component.html',
  styleUrls: ['./asset-maintenance-schedule-history-preview.component.scss']
})
export class AssetMaintenanceScheduleHistoryPreviewComponent implements OnInit {
