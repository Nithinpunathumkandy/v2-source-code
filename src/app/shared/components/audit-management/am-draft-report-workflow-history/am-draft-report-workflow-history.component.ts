...
// import { AmDraftReportWorkflowStore } from 'src/app/stores/risk-management/risks/risk-info-workflow.store';
// import { AmDraftReportStore } from 'src/app/stores/risk-management/risks/risks.store';
import { OrganizationGeneralSettingsStore } from 'src/app/stores/settings/organization-general-settings.store';


@Component({
  selector: 'app-am-draft-report-workflow-history',
  templateUrl: './am-draft-report-workflow-history.component.html',
  styleUrls: ['./am-draft-report-workflow-history.component.scss']
})
export class AmDraftReportWorkflowHistoryComponent implements OnInit {
  ...
  constructor(private _eventEmitterService:EventEmitterService,
    ...
    private _reportService:AmDraftWorkflowService,
  ...
  pageChange(newPage: number = null) {
    if (newPage) AmDraftReportWorkflowStore.setCurrentPage(newPage);
    this._reportService.getHistory(AmDraftReportStore.reportDetails?.id).subscribe(res=>{
  ...
  closeWorkflowHistory(){
    this._eventEmitterService.dismissAmDraftHistoryModal();
  }
