...
// import { AmPreliminaryReportWorkflowStore } from 'src/app/stores/risk-management/risks/risk-info-workflow.store';
// import { AmPreliminaryReportStore } from 'src/app/stores/risk-management/risks/risks.store';
import { OrganizationGeneralSettingsStore } from 'src/app/stores/settings/organization-general-settings.store';


@Component({
  selector: 'app-am-report-workflow-history',
  templateUrl: './am-report-workflow-history.component.html',
  styleUrls: ['./am-report-workflow-history.component.scss']
})
export class AmReportWorkflowHistoryComponent implements OnInit {
  ...
  constructor(private _eventEmitterService:EventEmitterService,
    ...
    private _reportService:AmPreliminaryWorkflowService,
  ...
  pageChange(newPage: number = null) {
    if (newPage) AmPreliminaryReportWorkflowStore.setCurrentPage(newPage);
    this._reportService.getHistory(AmPreliminaryReportStore.reportDetails?.id).subscribe(res=>{
  ...
  closeWorkflowHistory(){
    this._eventEmitterService.dismissAmPreliminaryHistoryModal();
  }
