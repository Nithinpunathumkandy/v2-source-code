...
@Component({
  selector: 'app-audit-plan-workflow-history',
...
export class AuditPlanWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) AmAuditPlanWorkflowStore.setCurrentPage(newPage);
  ...
  closeWorkflowHistory(){
    this._eventEmitterService.dismissAuditPlanHistoryModal();
  }
