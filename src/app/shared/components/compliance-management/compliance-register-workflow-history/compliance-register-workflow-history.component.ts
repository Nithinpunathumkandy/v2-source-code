...
@Component({
  selector: 'app-compliance-register-workflow-history',
  templateUrl: './compliance-register-workflow-history.component.html',
  styleUrls: ['./compliance-register-workflow-history.component.scss']
})
export class ComplianceRegisterWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) ComplianceRegisterWorkflowStore.setCurrentPage(newPage);
