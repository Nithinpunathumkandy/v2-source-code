...
@Component({
  selector: 'app-sla-contract-workflow-history',
  templateUrl: './sla-contract-workflow-history.component.html',
  styleUrls: ['./sla-contract-workflow-history.component.scss']
})
export class SlaContractWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) SlaContractWorkflowStore.setCurrentPage(newPage);
