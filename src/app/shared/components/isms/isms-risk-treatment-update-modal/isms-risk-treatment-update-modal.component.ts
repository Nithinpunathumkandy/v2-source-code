...
@Component({
  selector: 'app-isms-risk-treatment-update-modal',
  templateUrl: './isms-risk-treatment-update-modal.component.html',
  styleUrls: ['./isms-risk-treatment-update-modal.component.scss']
})
export class IsmsRiskTreatmentUpdateModalComponent implements OnInit {
...
function applyFill(slider) {
  ...
  closeUpdateModal(){
    ...
    this._eventEmitterService.dismissIsmsRiskTreatmentUpdateModal();
  }
  ...
  getUpdateModalDetails() {
    ...
    this.updateForm.patchValue({
      ...
      risk_treatment_status_id: IsmsRiskTreatmentStore?.riskTreatmentDetails?.risk_treatment_status.id ? IsmsRiskTreatmentStore?.riskTreatmentDetails?.risk_treatment_status.id : null,
