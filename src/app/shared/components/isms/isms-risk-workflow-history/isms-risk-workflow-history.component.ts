...
@Component({
  selector: 'app-isms-risk-workflow-history',
  templateUrl: './isms-risk-workflow-history.component.html',
  styleUrls: ['./isms-risk-workflow-history.component.scss']
})
export class IsmsRiskWorkflowHistoryComponent implements OnInit {
  ...
  pageChange(newPage: number = null) {
    if (newPage) IsmsRiskInfoWorkflowStore.setCurrentPage(newPage);
  ...
  closeWorkflowHistory(){
    this._eventEmitterService.dismissIsmsRiskInfoHistoryModal();
  }
