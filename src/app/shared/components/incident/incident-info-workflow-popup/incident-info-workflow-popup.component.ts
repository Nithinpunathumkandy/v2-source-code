...
@Component({
  selector: 'app-incident-info-workflow-popup',
  templateUrl: './incident-info-workflow-popup.component.html',
  styleUrls: ['./incident-info-workflow-popup.component.scss']
})
export class IncidentInfoWorkflowPopupComponent implements OnInit {
  ...
  isUser(){
    for(let i of IncidentInfoWorkflowStore?.workflowDetails){
