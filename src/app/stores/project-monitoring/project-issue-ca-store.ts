...
import { CaPaginationResponse, CorrectiveActions, IndividualCorrectiveAction, caHistoryData, caHistoryPaginationData } from "src/app/core/models/project-monitoring/project-issue-ca";
...
class Store {
    ...
    @observable
    orderItem: string = 'project_monitor_ca.id';
    ...
    @action
    setProjectIssueCaId(id: number) {
        this.ProjectIssueCaId = id;
...
export const CaStore = new Store();