...
import { IndividualRiskTreatment,RiskTreatment,RiskSummary,RiskTreatmentPaginationResponse,HistoryData,History } from "src/app/core/models/event-monitoring/risk-register/risk-treatments";
...
export const EventRiskTreatmentStore = new Store();