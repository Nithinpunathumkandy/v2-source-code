...
class Store {
    ...
    @action
    setComplianceMappingDetails(response: ComplianceMapping) {
    ...
    @computed
    get mappingItemList(): ComplianceMapping {
        return this._mappingList;
    }

}

export const ComplianceMappingStore = new Store();