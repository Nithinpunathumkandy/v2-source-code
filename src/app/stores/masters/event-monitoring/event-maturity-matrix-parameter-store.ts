...
import {EventMaturityMatrixParameter,EventMaturityMatrixParameterPaginationResponse,EventMaturityMatrixParameterSingle} from 'src/app/core/models/masters/event-monitoring/event-maturity-matrix-parameter';
...
class Store{
    ...
    @observable
    individualEventMaturityMatrixParameter: EventMaturityMatrixParameterSingle;
    ...
    setIndividualEventMaturityMatrixParameter(eventMaturityMatrixParameter: EventMaturityMatrixParameterSingle) {
        ...
        this.individualEventMaturityMatrixParameter = eventMaturityMatrixParameter;
    ...
    @action
    setLastInsertedeventMaturityMatrixParameter(eventMaturityMatrixParameterId: number){
        this.lastInsertedEventMaturityMatrixParameter = eventMaturityMatrixParameterId;
    }
    ...
    get individualEventMaturityMatrixParameterId(){
        return this.individualEventMaturityMatrixParameter;
    } 
