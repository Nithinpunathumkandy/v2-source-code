...
import { ActivityLoagsPaginationResponse, IndividualActivityLoags } from "src/app/core/models/kpi-management/kpi/activity-logs";
...
export const KpiActivityLogsStore = new Store();