...
import { ActivityLoagsPaginationResponse, IndividualActivityLoags } from "src/app/core/models/kpi-management/kpi-score/activity-logs";
...
export const KpiScoreActivityLogsStore = new Store();