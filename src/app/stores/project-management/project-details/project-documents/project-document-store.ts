...
import {  ProjectDocumentsPaginationResponse, IndividualProjectDocument,ProjectDocument } from 'src/app/core/models/project-management/project-details/project-documents/project-documents';
...
class Store {
    ...
    @action
    setProjectDocument(response: ProjectDocumentsPaginationResponse) {
