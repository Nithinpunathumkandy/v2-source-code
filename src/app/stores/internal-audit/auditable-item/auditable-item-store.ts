...
import { AuditableItem,AuditableItemPaginationResponse, Controls } from 'src/app/core/models/internal-audit/auditable-item/auditable-item';
...
class Store {
    ...
    @observable
    orderItem: string = 'auditable_items.id';
    ...
    auditable_item_id: number = null;

    @observable
    selectedControlsList: Controls[] = [];
    ...
    @action
    setAuditableItemId(id:number){
        this.auditable_item_id = id;
    }
    ...
    get auditableItemDetails() : AuditableItem{
