...
import { Likelihood, LikelihoodPaginationResponse, IndividualLikelihood } from 'src/app/core/models/hira/hira-configuration/likelihood';
class Store {
    @observable
    ...
    getLikelihoodById(id: number): IndividualLikelihood {
        ...
        LikelihoodStore.setIndividualLikelihoodDetails(likelihoodList);
...
export const LikelihoodStore = new Store();