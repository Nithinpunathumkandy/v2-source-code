...
import { MsauditCorrectiveAction, MsAuditCorrectiveActionPaginationResponse } from "src/app/core/models/ms-audit-management/corrective-actions/correcctive-actions";
import { caHistoryPaginationData, caHistoryData } from "src/app/core/models/non-conformity/finding-corrective-action";
import { Image } from "src/app/core/models/image.model";
class Store {

@observable
_correctiveActions : MsauditCorrectiveAction[] = [];
...
@observable
    individualCorrectiveAction: MsauditCorrectiveAction;
...
@action
setMsCorrectiveActions(response : MsAuditCorrectiveActionPaginationResponse){
...
setFindingCorrectiveActions(caItems: MsauditCorrectiveAction[]){
...
@action
    ...
    @action
    setIndividualCorrectiveActionDetails(actionPlan: MsauditCorrectiveAction) {
  ...
  @computed
    ...
    @action
    getActionPlanById(id: number): MsauditCorrectiveAction {
...
export const AuditCorrectiveActionStore = new Store()