...
import { FindingDepartmentPagination, FindingDepartmentPage, } from "src/app/core/models/external-audit/dashboard/dashboard";
...
export const EADepartmentRiskStore = new Store();