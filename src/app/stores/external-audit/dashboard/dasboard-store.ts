...
import { ActionPlans, CorrectiveActionOpenCloseCount, DepartmentFindings, CorrectiveActionDepartment, CorrectiveActionResponsibleUser, AuditMsTypeCount,  OverdueActionPlans, StatusWiseAnalysisFindings, AuditTypeCount, Top10Findings, Top10List, Top10PaginationResponse, CorrectiveActionsByDepartment, CorrectiveActionsByResponsibleUser} from "src/app/core/models/external-audit/dashboard/dashboard";
...
class Store{
    ...
    @observable
    private _auditTypeCount: AuditTypeCount[]=[];
    ...
    @observable
    private _auditMsTypes: AuditMsTypeCount[] = [];
    ...
    @action
    setAuditMsTypes(res: AuditMsTypeCount[]) {
        this._auditMsTypes = res;
    }

    @action
    unsetAuditMsTypes() {
        this._auditMsTypes = null;
    }
    ...
    @computed
    get auditMsTypes():AuditMsTypeCount[]{
        return this._auditMsTypes.slice()
    }
    ...
    @action
    setAuditByTypes(res: AuditTypeCount[]) {
        this._auditTypeCount = res;
    }
    ...
    @computed
    get AuditByTypeCount():AuditTypeCount[]{
        return this._auditTypeCount.slice()
    }
...
export const ExternalAuditDashboardStore = new Store();