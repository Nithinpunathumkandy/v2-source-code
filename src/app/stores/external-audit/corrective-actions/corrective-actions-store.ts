...
import { caHistoryPaginationData, caHistoryData } from "src/app/core/models/external-audit/corrective-action/corrective-action";
...
class Store {
    ...
    @observable
    private _externalAuditCorrectiveActions: ExternalAuditCorrectiveActions[] = [];
    ...
    @observable
    individualCorrectiveAction: ExternalAuditCorrectiveActions;
    ...
    @observable
    orderItem: string = 'corrective_actions.created_at';
    ...
    setFindingCorrectiveActions(caItems: ExternalAuditCorrectiveActions[]){
        this._externalAuditCorrectiveActions = caItems;
        this.loaded = true;
    }


    @action
    setAllCorrectiveAction(response: ExternalAuditCorrectiveActionsPaginationResponse) {
       
        this._externalAuditCorrectiveActions = response.data;
    ...
    @action
    setIndividualCorrectiveActionDetails(actionPlan: ExternalAuditCorrectiveActions) {
    ...
    unsetCorrectiveActions(){
        this._externalAuditCorrectiveActions = [];
        this.currentPage = 1;
        this.loaded = false;
    }
    ...
    @computed
    get allItems(): ExternalAuditCorrectiveActions[] {
        
        return this._externalAuditCorrectiveActions;
    }
    ...
    @action
    getActionPlanById(id: number): ExternalAuditCorrectiveActions {
        return this._externalAuditCorrectiveActions.slice().find(e => e.id == id);
    }
    ...
    get initialItemId():number{
        return this._externalAuditCorrectiveActions[0].id
    }
...
export const ExternalAuditCorrectiveActionStore = new Store();
