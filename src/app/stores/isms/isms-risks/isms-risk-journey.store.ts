...
import { RiskJourney , RootCauseAnalysis , RiskSummary , RiskTreatment } from 'src/app/core/models/risk-management/risks/risk-journey';
...
export const IsmsRiskJourneyStore = new Store();