...
export interface MsAuditCorrectiveActionPaginationResponse {
    current_page: number;
    total: number;
    per_page: number;
    last_page: number;
    from: number;
    data: MsauditCorrectiveAction[];
}

export interface MsauditCorrectiveAction{
    id: number;
    title: string;
    closed_by: CreatedBy
    description:string;
    ...
    ms_audit_finding_id:number;
    ms_audit_finding_corrective_action_status: CorrectiveActionStatus
    ms_audit_finding_corrective_action_status_updates: CorrectiveActionStatusUpdates[]
    resolved_by :{
        created_at:string;
        comment: string;
        percentage: number;
    ...
    export interface CorrectiveActionStatusUpdates{
        ...
        ms_audit_finding_corrective_action_update_documents: Documents[]
        id: number;
        percentage: number;
    }
