export interface ModuleGroupsResponse {
    data:IncidentManagementModules[]
}

export interface IncidentManagementModules {
    module_id: number;
    module: string;
}
...
export interface IncidentWorkflowPaginationResponse {
    current_page: number;
    total: number;
    per_page: number;
    last_page: number;
    from: number;
    data: IncidentWorkflow[];
}

export interface SingleIncidentWorkflow {
    id: number;
    title: string;
    created_at: string;
