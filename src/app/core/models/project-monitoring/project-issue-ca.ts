...
export interface CorrectiveActions {
    ...
    project_issue_corrective_action_status: string;
    project_issue_corrective_action_status_id: number;
    project_issue_corrective_action_status_label:string;
...
export interface IndividualCorrectiveAction {
    ...
    created_at: string;
    project_issue_corrective_action_update:ProjectIssueCorrectiveActionUpdate[]; 
    
}

export interface ProjectIssueCorrectiveActionUpdate{
    id:number;
    project_issue_corrective_action_id:number
    project_issue_corrective_action_status_id:number
    percentage:number;
    comment:string;
    created_by:CreatedBy
...
export interface caHistoryData{
    ...
    created_by_status: string;
    project_issue_corrective_action_status_id: number;
    project_issue_corrective_action_status_title: string;
    id: number;
    comment: string;
    documents;
    percentage: number;
