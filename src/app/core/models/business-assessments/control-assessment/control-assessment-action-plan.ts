...
export interface CAActionPlanStatus{
...
export interface CAActionPlanDetails{
    ...
    start_date: string;
    target_date: string;
    business_assessment_action_plan_status:CAActionPlanStatus;
    control_assessment_document_version_content_control:any;
    created_at:string;
    created_by:CreatedBy;
    description:string;
...
export interface CAActionPlanPaginationResponse{
    current_page:number;
    per_page:number;
    total:number;
    from:number;
