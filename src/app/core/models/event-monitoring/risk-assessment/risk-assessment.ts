...
import { BusinessContinuityPlanStatusLanguage } from "../../masters/bcm/business-continuity-plan-status";
...
export interface EventRiskAssessmentDetails{
    created_at
...
export interface EventRiskAssessmentPaginationResponse{
    current_page:number;
    per_page:number;
    total:number;
    data:EventRiskAssessment[];
}

export interface BcmRiskAssessmentVersions{
    business_continuity_plan_id: number;
    business_continuity_plan_status_id: number;
    contents: EventRiskAssessmentContents[];
    id: number;
    is_latest: number;
    title: string;
}

export interface EventRiskAssessmentContents{
...
export interface EventRiskAssessmentWorkFlowDetails{
...
export interface WorkFlowHistoryPaginationResponse{
    ...
    per_page:number;
    total:number;
    data:EventRiskAssessmentWorkflowHistory[];
}

export interface EventRiskAssessmentWorkflowHistory{
    comment: string;
    created_at: string;
    created_by: number;
