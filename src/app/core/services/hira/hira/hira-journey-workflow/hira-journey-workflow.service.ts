...
import { RiskInfoWorkflowDetail, RiskWorkflowHistoryPaginationResponse } from 'src/app/core/models/hira/hira-register/hira-info-workflow';
import { map } from 'rxjs/operators';
import { HttpClient } from '@angular/common/http';
import { UtilityService } from 'src/app/shared/services/utility.service';
import { RiskJourneyWorkflowStore } from 'src/app/stores/hira/hira/hira-journey-workflow.store';

@Injectable({
  providedIn: 'root'
})
export class HiraJourneyWorkflowService {
