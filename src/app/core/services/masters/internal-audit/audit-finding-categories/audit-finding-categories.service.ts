...
export class AuditFindingCategoriesService {
  ...
  constructor(private _http: HttpClient,
    ...
    getItems(getAll: boolean = false,additionalParams?:string,is_all:boolean = false): Observable<AuditFindingCategoryPaginationResponse> {
      ...
      return this._http.get<AuditFindingCategoryPaginationResponse>('/finding-categories' + (params ? params : '')).pipe(
    ...
    getAllItems(): Observable<AuditFindingCategory[]> {
      return this._http.get<AuditFindingCategory[]>('/finding-categories').pipe((
    ...
    saveItem(item: AuditFindingCategory) {
      return this._http.post('/finding-categories', item).pipe(
        map((res:any )=> {
    ...
    updateItem(id:number, item: AuditFindingCategory): Observable<any> {
      return this._http.put('/finding-categories/' + id, item).pipe(
        map(res => {
    ...
    delete(id: number) {
      return this._http.delete('/finding-categories/' + id).pipe(
        map(res => {
    ...
    activate(id: number) {
      return this._http.put('/finding-categories/' + id + '/activate', null).pipe(
        map(res => {
    ...
    deactivate(id: number) {
      return this._http.put('/finding-categories/' + id + '/deactivate', null).pipe(
        map(res => {
    ...
    generateTemplate() {
      this._http.get('/finding-categories/template', { responseType: 'blob' as 'json' }).subscribe(
        (response: any) => {
    ...
    exportToExcel() {
      this._http.get('/finding-categories/export', { responseType: 'blob' as 'json' }).subscribe(
        (response: any) => {
    ...
    shareData(data){
      return this._http.post('/finding-categories/share',data).pipe(
        map((res:any )=> {
    ...
    importData(data){
      ...
      return this._http.post('/finding-categories/import',data).pipe(
        map((res:any )=> {
